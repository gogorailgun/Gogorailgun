...
public class Test04 {
	public Test04(){
		int no1 = (int)(Math.random() * 16 + 5); // 5~16
		int no2 = (int)(Math.random() * 16 + 5); // 5~16
...
class Semo extends Figure{
	...
	@Override
	public void toPrint() {
		System.out.println("semo 클래스 : 가로 - "+ width + " | 세로 : " + height + "| 넓이 : " + area);
	}
...
class Dongle extends Figure{
	...
	public void setArround() {
		arround = (int)(2 * rad * Math.PI * 100 + 0.5)/100.0;
		
	}
	@Override
	public void setArea() {
		area = (int)(rad * rad * Math.PI*100 + 0.5)/100.0;
	}
