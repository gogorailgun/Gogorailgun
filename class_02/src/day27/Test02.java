	...
	public void joinEvt() {
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// 카운트 값에 따라 적당히 처리해준다.
				if(cnt == 1) {
					// 이때는 입력한 아이디를 사용하는 사람이 이미 있는 경우
					// 따라서 다시 입력받아야 한다.
					id.setText("");
					JOptionPane.showMessageDialog(null, "<html><h2 style=\"color: red\">" + sid + " 는 사용중인 아이디입니다. </h2></html>");
					return;
				} else {
					JOptionPane.showMessageDialog(null, "<html><h2 style=\"color: blue\">"+ sid + " 는 사용 가능한 아이디입니다. </h2></html>");
				}
...
//				System.out.println(mVO);
				...
				if(cnt == 1) {
					...
					JOptionPane.showMessageDialog(null, "<html><h2 style=\"color: red\">" + sid + " 는 가입 취소되었습니다. </h2></html>");
